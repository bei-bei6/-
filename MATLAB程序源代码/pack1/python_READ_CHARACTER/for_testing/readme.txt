python_READ_CHARACTER MATLAB Python Package
...
2. Installing the python_READ_CHARACTER Package

A. Change to the directory that contains the file setup.py and the subdirectory 
python_READ_CHARACTER. If you do not have write permissions, copy all its contents to a 
...
3. Using the python_READ_CHARACTER Package

The python_READ_CHARACTER package is on your Python path. To import it into a Python 
script or session, execute:

    import python_READ_CHARACTER
