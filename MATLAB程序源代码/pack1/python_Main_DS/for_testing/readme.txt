python_Main_DS MATLAB Python Package
...
2. Installing the python_Main_DS Package

A. Change to the directory that contains the file setup.py and the subdirectory 
python_Main_DS. If you do not have write permissions, copy all its contents to a 
...
3. Using the python_Main_DS Package

The python_Main_DS package is on your Python path. To import it into a Python script or 
session, execute:

    import python_Main_DS
