python_DESIGN_POINT MATLAB Python Package
...
2. Installing the python_DESIGN_POINT Package

A. Change to the directory that contains the file setup.py and the subdirectory 
python_DESIGN_POINT. If you do not have write permissions, copy all its contents to a 
...
3. Using the python_DESIGN_POINT Package

The python_DESIGN_POINT package is on your Python path. To import it into a Python script 
or session, execute:

    import python_DESIGN_POINT
